...
if(isset($_POST['currencyId'])){
	...
	$record["symbolLeft"] = $db->mySQLSafe(htmlspecialchars($_POST['symbolLeft']));
	$record["symbolRight"] = $db->mySQLSafe(htmlspecialchars($_POST['symbolRight']));
...
?>
<p class="pageTitle">Currency Manager</p>
<?php
if(isset($msg)){ 
	echo $msg;
} else { 
?>
<p class="copyText"><?php echo $lang['admin']['settings']['currencies_desc'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=convert.php class="txtLink">Auto update Currencies</a></p>
<?php } ?>
...
<table border="0" cellspacing="0" cellpadding="3" class="mainTable">
  ...
  <tr>
    ...
    <td align="center" class="<?php echo $cellColor; ?>"><img src="../images/<?php echo $currencies[$i]['active']; ?>.gif" alt="" /></td>
