 ...
 * Changelog
 * ---------------------------------------------
 * Cleanup and bugfix, Ray, 13.09.11
 *
 */
...
if (isset($_POST['module'])) {
	...
	//foreach ($module as $key => $value) echo "{$key} ... {$value}<br/>";	
	//exit;
...
<table border="0" cellspacing="0" cellpadding="3" class="mainTable">
	...
	<tr>
  	...
  	<tr>
    	<td align="left" valign="top" class="tdOdd"><span class="copyText"><strong>Zone 1 Countries:</strong><br/>(List comma separated ISO codes)</span></td>
    	<td class="tdOdd"><textarea name="module[zone1Countries]" cols="40" rows="2" class="textbox"><?php echo $module['zone1Countries']; ?></textarea></td>
  	</tr>
  	...
  	<tr>
    	<td align="left" valign="top" class="tdOdd"><span class="tdText"><strong>Zone 1 Shiping 2nd Class Rates:</strong><br/>(Comma Separated) </span></td>
    ...
    <tr>
    	<td align="left" valign="top" class="tdOdd"><span class="tdText"><strong>Zone 1 Shiping Special Class Rates:</strong><br/>(Comma Separated) </span></td>
    	<td class="tdOdd"><input type="text" name="module[zone1RatesClass2]" value="<?php echo $module['zone1Special']; ?>" class="textbox" size="40" /></td>
  	</tr>

  	<tr>
    	<td align="left" class="tdText" class="tdEven"><strong>Zone 1 Tax Class: </strong></td>
    	<td class="tdText"><?php $tax = $db->select("SELECT * FROM ".$glob['dbprefix']."CubeCart_taxes"); ?>
		<select name="module[zone1tax]">
		<?php for($i=0; $i<count($tax); $i++){ ?>
			<option value="<?php echo $tax[$i]['id']; ?>" <?php if($module['zone1tax'] == $tax[$i]['id']) echo "selected='selected'"; ?>>
    ...
    <tr>
    	...
    	<td class="tdEven"><textarea name="module[zone2Countries]" cols="40" rows="2" class="textbox"><?php echo $module['zone2Countries']; ?></textarea></td>
  	</tr>
  	...
  	<tr>
		<td align="left" valign="top" class="tdEven"><span class="tdText"><strong>Zone 2 Shiping 1st Class Rates:</strong> <br />(Comma Separated)</span></td>
  	...
  	<tr>
    	<td align="left" valign="top" class="tdEven"><span class="tdText"><strong>Zone 2 Shiping 2nd Class Rates:</strong><br />(Comma Separated)</span></td>
	...
	<tr>
    	<td align="left" class="tdText" class="tdEven"><strong>Zone 2 Tax Class: </strong></td>
    	<td class="tdText"><?php $tax = $db->select("SELECT * FROM ".$glob['dbprefix']."CubeCart_taxes"); ?>
		<select name="module[zone2tax]">
		<?php for($i=0; $i<count($tax); $i++){ ?>
			<option value="<?php echo $tax[$i]['id']; ?>" <?php if($module['zone2tax'] == $tax[$i]['id']) echo "selected='selected'"; ?>>
				<?php echo $tax[$i]['taxName']; ?>
			</option>
		<?php } ?>
		</select>
    ...
    <tr>
    	...
    	<td class="tdOdd"><textarea name="module[zone3Countries]" cols="40" rows="2" class="textbox"><?php echo $module['zone3Countries']; ?></textarea></td>
	</tr>
  	...
  	<tr>
    	<td align="left" valign="top" class="tdOdd"><span class="tdText"><strong>Zone 3 Shiping 2nd Class Rates:</strong> <br />(Comma Separated)</span></td>
  	...
  	<tr>
    	<td align="left" class="tdText" class="tdOdd"><strong>Zone 3 Tax Class: </strong></td>
    	<td class="tdText"><?php $tax = $db->select("SELECT * FROM ".$glob['dbprefix']."CubeCart_taxes"); ?>
		<select name="module[zone3tax]">
		<?php for($i=0; $i<count($tax); $i++){ ?>
			<option value="<?php echo $tax[$i]['id']; ?>" <?php if($module['zone3tax'] == $tax[$i]['id']) echo "selected='selected'"; ?>>
				<?php echo $tax[$i]['taxName']; ?>
			</option>
		<?php } ?>
		</select>
    ...
    <tr>
    	...
    	<td class="tdEven"><textarea name="module[zone4Countries]" cols="40" rows="2" class="textbox"><?php echo $module['zone4Countries']; ?></textarea></td>
  	</tr>
	...
	<tr>
  	...
  	<tr>
    	<td align="left" valign="top" class="tdEven"><span class="tdText"><strong>Zone 4 Shiping<span class="tdOdd"><strong> 1st Class</strong></span> Rates:</strong><br />(Comma Separated)</span></td>
  	...
  	<tr>
    	<td align="left" valign="top" class="tdEven"><span class="tdText"><strong>Zone 4 Shiping<span class="tdOdd"><strong> 2nd Class</strong></span> Rates:</strong><br />(Comma Separated) </span></td>
  	...
  	<tr>
    	<td align="left" class="tdText" class="tdEven"><strong>Zone 4 Tax Class: </strong></td>
    	<td class="tdText"><?php $tax = $db->select("SELECT * FROM ".$glob['dbprefix']."CubeCart_taxes"); ?>
		<select name="module[zone4tax]">
		<?php for($i=0; $i<count($tax); $i++){ ?>
			<option value="<?php echo $tax[$i]['id']; ?>" <?php if($module['zone4tax'] == $tax[$i]['id']) echo "selected='selected'"; ?>>
				<?php echo $tax[$i]['taxName']; ?>
			</option>
		<?php } ?>
		</select>
