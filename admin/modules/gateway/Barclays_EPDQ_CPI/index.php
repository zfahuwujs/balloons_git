...
<p><img src="logo.gif" alt="" border="0" title="" /></p>
<?php 
if(isset($msg)){ 
        echo stripslashes($msg); 
} 
?>
<p class="copyText">This module integrates the Barclays EPDQ CPI Interface</p>
...
<table border="0" cellspacing="0" cellpadding="3" class="mainTable">
  ...
  <tr>
  <td align="left" class="tdText"><strong>Merchant Display Name:</strong></td>
    <td class="tdText"><input type="text" name="module[display]" value="<?php echo $module['display']; ?>" class="textbox" size="30" /></td>
  </tr>
    <tr>
  <td align="left" class="tdText"><strong>Merchant/Client ID:</strong></td>
    <td class="tdText"><input type="text" name="module[clientid]" value="<?php echo $module['clientid']; ?>" class="textbox" size="30" /></td>
  </tr>
      <tr>
  <td align="left" class="tdText"><strong>Merchant Passphrase:</strong></td>
