...
<select name="module[currency]">
	<option value="$|036" <?php if($module['currency'] == "$|036") echo "selected='selected'"; ?>>Australian Dollars</option>
	<option value="$|124" <?php if($module['currency'] == "$|124") echo "selected='selected'"; ?>>Canadian Dollars</option>
	<option value="Û|978" <?php if($module['currency'] == "Û|978") echo "selected='selected'"; ?>>Euro</option>
	<option value="$|554" <?php if($module['currency'] == "$|554") echo "selected='selected'"; ?>>New Zealand Dollars</option>
	<option value="CHF|756" <?php if($module['currency'] == "CHF|756") echo "selected='selected'"; ?>>Swiss Francs</option>
	<option value="£|826" <?php if($module['currency'] == "£|826") echo "selected='selected'"; ?>>UK Pound Sterling</option>
	<option value="$|840" <?php if($module['currency'] == "$|840") echo "selected='selected'"; ?>>US Dollars</option>
</select></td>
<td class="tdText">This is the currency for the module. It should match both your store's default currency, and that of your HSBC Merchant Account</td>
  </tr>
  ...
  <tr>
 <td align="left" class="tdText"><strong>Alias:</strong></td>
   <td class="tdText"><input type="text" name="module[userAlias]" value="<?php echo $module['userAlias']; ?>" class="textbox" size="30" /></td>
   <td class="tdText">This is your HSBC Alias ID, found in the header of Secure ePayments after logging in. Typically of the format UK12345678GBP (13 characters)</td>
    ...
    <tr>
  <td align="left" class="tdText"><strong>Enable American Express Processing:</strong></td>
      <td class="tdText">
	<select name="module[amex]">
		<option value="1" <?php if($module['amex'] == 1) echo "selected='selected'"; ?>>Yes</option>
		<option value="0" <?php if($module['amex'] == 0) echo "selected='selected'"; ?>>No</option>
	</select>
	</td>
