...
<table border="0" cellspacing="0" cellpadding="3" class="mainTable">
  ...
  <td align="left" class="tdText"><strong>Token ID:</strong></td>

    <td class="tdText"><input type="text" name="module[tokenId]" value="<?php echo $module['tokenId']; ?>" class="textbox" size="30" /></td>
