...
<form action="<?php echo $GLOBALS['rootRel'];?>admin/login.php?goto=<?php echo treatGet($_GET['goto']); ?>" method="post" enctype="multipart/form-data" name="AdminLogin" target="_self">

<div style="margin: auto; align: center; width: 190px; padding-bottom: 10px;"><a href="index.php"><img src="<?php echo $GLOBALS['rootRel']; ?>admin/images/evo/adminLogo.png" alt="" width="177" height="57" border="0" title="Admin Log in" /></a></div>

<table border="0" align="center" width="224" cellpadding="4" cellspacing="0" class="mainTable">
