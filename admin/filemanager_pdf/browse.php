...
foreach ($dirArray as $file) {
	...
	$IMAGES_BASE_DIR = preg_replace("#//+#", '/', "../../pdf/");
	...
	if (CheckImgExt(strtolower($file))) {
		...
		$files[$i]['name'] = str_replace("../../pdf/","",$file);	//adding filenames to array
...
var sImagesPath  = "<?php echo $GLOBALS['rootRel']."pdf/"; ?>";
