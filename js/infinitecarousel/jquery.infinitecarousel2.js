	...
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
			...
			for(i=1;i<=o.inView;i++)
			{
				...
				$('#textholder'+randID+'_'+i).height((imgHeight*o.textholderHeight)-10).css({'color':'#FFFFFF','backgroundColor':'#000000','opacity':'0.7', 'padding':'5px 10px', 'font-weight':'bold'});
			...
			if(o.showControls)
			{
				...
				html = '<div id="btn_rt'+randID+'" style="position:absolute;right:2px;top:'+arrowsTop+'px;cursor:pointer;border:none;width:40px;height:40px;background:url('+o.imagePath+'leftright.png) no-repeat 0 0"></div>';
				html += '<div id="btn_lt'+randID+'" style="position:absolute;left:2px;top:'+arrowsTop+'px;cursor:pointer;border:none;width:40px;height:40px;background:url('+o.imagePath+'leftright.png) no-repeat -40px 0"></div>';
