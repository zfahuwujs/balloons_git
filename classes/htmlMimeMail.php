...
*/
...

	{
		...
		if (isset($message)) {
			...
			$message_id = sprintf('<%s.%s@%s>', base_convert(time(), 10, 36), base_convert(rand(), 10, 36), !empty($GLOBALS["_SERVER"]['HTTP_HOST']) ? $GLOBALS["_SERVER"]['HTTP_HOST'] : $GLOBALS['SERVER_NAME']);
