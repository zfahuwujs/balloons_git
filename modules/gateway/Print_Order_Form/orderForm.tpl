...
{VAL_STORE_URL}</td>
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="7" cellspacing="0" style="padding: 7px;">
      ...
      <tr>
	    <td class="copyText">{LANG_DISCOUNT}</td>
	    <td align="right" class="copyText">{VAL_DISCOUNT}</td>
	    </tr>
	  <tr>
	  <tr>
	  ...
	  <tr>
	    <td colspan="3" align="right" class="copyText">{LANG_SHIPPING}</td>
	    <td align="right" class="copyText">{VAL_SHIPPING}</td>
	    </tr>
	  <tr>
	    <td colspan="3" align="right" style="border-top: 1px solid #000000;" class="copyText"><strong>{LANG_GRAND_TOTAL}</strong></td>
