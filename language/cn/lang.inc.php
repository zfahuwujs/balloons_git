...
'ini_set_desc' => "這裡顯示您目前主機環境設定. 這包含各種資訊可供您參考及當您使用 Cart 時所遭受到問題. 注意. 如果您使用虛擬主機或分享主機，您將會限制無法修改某些設定. </span> <a href='http://www.php.net/ini_set' target='_blank' class='txtLink'>ini_set()</a> <span class='copyText'> 功能可以取代這些設定.",
...
'welcome_note' => "歡迎來到 Cart 後端管理控制介面",
...
'admin_email_body_1' => "Dear Cart Store Administrator,
...
'installation' => "Cart Installation v%s",
...
<p><strong>Why do I get the error message &quot;Call to undefined function: imagecreatefromjpg()&quot;?<br />
  ...
  </strong>This is because your web server is not configured to have GD enabled. To run Cart GD version 1 or above is required. Please contact your host and ask them nicely to enable it for you but you must remember that they are not obliged to do this for you. If you can't use GD either seek an alternative hosting company or set your GD version to be &quot;None&quot;.</p>",

'mysqlDBSettings' => "MySQL Database Settings",



'mysqlDBSettingsDesc' => "<p>To run Cart on your server you are required to have one MySQL database for it to store information such as your product and customer details. If your are attempting to install Cart on a shared (virtual) hosting environment then your hosting provider should be able to provide you with the information required for this stage of the install process. This information should include database name, username, password and the hostname. Sometimes you will find that you can setup and manage your MySQL database(s) from your hosting control panel. If however you are installing Cart on a testing machine or a dedicated server you may need to consult the <a href='http://dev.mysql.com/doc/mysql/en/index.html' target='_blank'>MySQL manual</a>. </p>
