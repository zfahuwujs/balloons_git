...
'sessions_desc' => "Below shows the last login attempts to admin. Keep an eye on this to ensure that there are no Hijacking attempts. It is strongly recommend that you change your admin password regularly.",
...
'used_to_download' => "This is used to download email addresses to be used in bulk email software.",

'bulk_to_subscribed' => "This allows you to send a bulk email ONLY to those who have subscribed to the mailing list through this website. This will ONLY send to the first 1000 customers in your database.",
...
'current_doc_list' => "Below is a list of all the current site documents. These can be edited and/or deleted at any time.",
...
'search' => "Search for an image by name:",
...
'purchase_cubecart' => "Purchase Licence:",

'invalid_key' => "Sorry but the license key was invalid or has already been used.",

'purchase_license_key' => "Purchase License Key",

'run_unlicensed' => "You appear to be running an unlicensed version. Please enter your license key below in order to remove copyright.",
...
'ini_set_desc' => "The information below shows your current server environment settings. This contains all kinds of information  which may need to be changed if you are experiencing problems with your shopping cart. N.B. If you have a shared server or virtual hosting it is likely that you will have limited access to modify settings. The</span> <a href='http://www.php.net/ini_set' target='_blank' class='txtLink'>ini_set()</a> <span class='copyText'> function can often be used to override these settings.",
...
'send_invoice_desc' => "If status is changed from Pending to Processing you will get the option to send the customer an invoice reciept and grant access to digital products if applicable.",
...
'email_sent_from' => "This email was automaticaly sent from %s",
...
'containing_text' => "containg the text",
...
<p>The advantage of using the server root path is that files can be stored elsewhere than the publically accessible folder. If this method is chosen the cart will automatically create a download link which has an expiry time and max amount of downloads which is configured in the store settings.</p>",
...
// start: Related Products mod
$lang['admin']['related_prods'] = array (

'related_products' => "Related Products",

'manage_related_products' => "Manage Related Products",

'install_success' => "Installation successful. New tables have been created.",

'install_failure' => "Error installing new tables.",

'invalid_product' => "Selected product is invalid.",

'invalid_enter_id' => "Entered product ID is invalid.",

'invalid_enter_code' => "Entered product code is invalid.",

'add_success' => "Added related product successfully.",

'add_failure' => "Error adding related product.",

'add_exists' => "That related product has already been added.",

'delete_success' => "Removed related product successfully.",

'delete_failure' => "Error removing related product.",

'config' => "Global Configuration Settings",

'show_config' => "[+] Show / Edit Configuration Settings",

'hide_config' => "[-] Hide Configuration Settings",

'show_help' => "[?] Show Help",

'update' => "Update",

'config_not_unique' => "These are the global configuration settings. They are *not* unique to each product.",

'status' => "Status:",

'max_shown' => "Max Related Products Shown:",

'max_shown_help' => "This defines the maximum number of related products that will be shown for each product.",

'auto_search' => "Enable Auto Search?",

'auto_search_help' => "Do you wish to enable the automatic search for related products? The automatic search will use the product's title and optionally its description in order to search for similar products.",

'desc' => "Auto Search - Use Product Description?",

'desc_help' => "Do you wish to use the words in the product description for the auto search?",

'advanced_options' => "Auto Search Advanced Options",

'desc_up_to' => "Use Product Description Up To:",

'desc_up_to_help' => "The product description, up to the first \"terminator\" found, will be used for the auto search. So you could keep this field blank to use the full product description, or enter a full stop to use only the first sentence. HTML tags are also accepted, eg. &lt;br/&gt; or &lt;/p&gt;<br/>(Leave this field blank if you are unsure)",

'comma_separated' => "(Comma separated)",

'ignore' => "Words to Ignore:",

'ignore_help' => "Words in the product title or product description which should not be used in the auto search. This is useful if the results from the auto search are matching inappropriately, e.g. matching on words such as: quality, bargain, limited, special, etc",

'selected_prod' => "Selected Product",

'auto_search_words' => "Auto Search Words:",

'from_name' => "From Name:",

'from_desc' => "From Description:",

'help_selected' => "The Auto Search Words shown above are based on your configuration settings. Please note that words shorter than 4 characters cannot be used in the Auto Search.",

'add' => "Add Related Product",

'enter_id' => "Enter Product ID:",

'case_sensitive' => "(Case sensitive)",

'help_add' => "To link another product with this product, enter the product ID. You can use Admin -> View Products to locate or search for the related product you want to add.<br/><br/>
    Please note that your related products will be displayed before any auto search results (if enabled), and your manually related products will be displayed in the same order in which you add them.<br/><br/>
    The maximum number of related items (both manual and auto) that will be displayed in your store is defined in your Configuration Settings.",

'view_or_remove' => "View / Remove Related Products",
...
'spambot' => "Enable Script/Bot Flood Control?",

'spambot_desc' => "Forces users to enter a code on registration, tell a friend etc to prevent bot's from spamming the store.",

//////////////////////////////////////////
// END: Added in 3.0.3
//////////////////

/* Added for Homepage Categories - MarksCarts http://cc3.biz */
'show_homepagecats' => "Show Categories on homepage?",

'show_latest' => "Show Latest Products on homepage?",

'no_latest' => "Number of latest products to show:",

'off_line_settings' => "Offline Settings - Only edit here after discussing with your account manager",

'off_line' => "Turn store off?",

'off_line_content' => "Off line message:",

'off_line_allow_admin' => "Allow adminstrators to view store off line? (Requires admin session)",


'store_settings' => "Store Settings",

'edit_below' => "Please edit your store configuration setings below:",

'meta_data' => "Meta Data - Only edit options here if you know what you are doing",
...
'zone' => "County/Region/Zone:",

'dirs_folders' => "Directories &amp; Folders - DO NOT EDIT anything in this section",
...
'eg_domain_SSL' => "e.g. https://secure.domain.com",
...
'digital_downloads' => "Digital Downloads - DO NOT EDIT anything in this section",
...
'styles_misc' => "Styles &amp; Misc - Only edit these options after discussing with your account manager",
...
'gd_settings' => "GD Settings - DO NOT EDIT anything in this section",
...
'stock_settings' => "Stock Settings - Only edit after discussion with your account manager",
...
'time_and_date' => "Time &amp; Date - DO NOT EDIT anything in this section",
...
'locale_settings' => "Locale Settings - Only edit here after discussion with your account manager",

'default_currency' => "Default Currency",

'inc_tax_prices' => "Include tax in prices?",
...
'edit_countries_below' => "Please only add, edit or delete countries below if you know what you are doing.  If you are unsure then please discuss with your account manager:",
...
'warn_del_country' => "Are you sure you want to delete this? All counties, rehions and zones will be deleted above it.",

'no_countries_in_db' => "There are no countries in the database.",

'edit_counties' => "Please add edit or delete counties/zones/regions below:",

'no_counties_in_db' => "There are no counties, states or zones in the database.",

'tax_Settings' => "Tax Settings",

'edit_locale_below' => "Please edit your locale setings below:",
...
'global_risk' => "WARNING: The main configuration file 'includes/global.inc.php' is writeable and your store is at risk. Please change these permissions to 0644 as soon as possible.",

'401' => "Error 401: You do not have permission to access that page. Please ask one of the super users to grant this for you.",

'welcome_note' => "Welcome to your Website Administration Control Panel - You can manage most aspects of your store from here such as adding and removing products and categories, editing tax and currency settings.<br/><br/> 

Please use the menu system on the left to navigate throughout the different options, if you are unsure about any changes then please contact your account manager first. ",

'last_login' => "Last login was on ",
...
'visit_cc' => "Visit the Downloads Server",
...
'admin_email_body_1' => "Dear Store Administrator,
...
'session_destroyed' => "You are now logged out, please Visit again soon!",
...
'installation' => "Your Cart Installation v%s",
...
/// CUSTOMER REVIEW MOD  START 

$lang['review'] = array ( 

'fill_out_form' => "Please fill out the form below to leave your product review.",
'cust_name' => "Please enter your name:",
'review_title' => "Add a Product Review",
'order_req' => "All fields marked with ' * ', must be filled in.",
'try_again' => "Please try again",
'success' => "Thank you, your product review has been submitted",
'error_mess' => "Please fill in all required fields marked with  *",
'ip_error_mess' => "You have already left a review for this product!",
'need_reg' => "You need to be a registered user to leave a product review, Please Login or Register.",
'success' => "Thank you, Your review has been submitted and is awaiting approval",
);

$lang['admin']['review'] = array (

'reviews' => "Customer Reviews",
'reviews_new' => "New Reviews",
'reviews_public' => "Public Reviews",
'del_comments' => "Delete Comments",
'back_comments' => "Back to Comments",
'comment_deleted' => "Comment Deleted",
'no_comments' => "No Comments",
'comment_not_public' => "Not Public",
'comment_public' => "Public",
'change_comment' => "Change Comment",
'comment_without_save' => "Back to comments without saving!",
'renew_comment' => "Comment is Updated!",
'customer_name' => "Customers Name",
);

$lang['review']['form'] = array (
...
'star4' => "4 - very good",
'star5' => "5 - excellent",
'star_choose' => "Please Choose a Rating",
'submit_review' => "Submit Review",
);

   $cust_rev = "Customer Reviews";
   
/// CUSTOMER REVIEW MOD  END  
...
$lang['admin']['products']['clone'] = "Clone";
// now we need to include the config file 

include("config.inc.php");
include("sw_sort_order_lang.inc.php");
?>
