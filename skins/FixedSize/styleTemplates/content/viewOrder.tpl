...
<div class="boxContent">
  ...
  <br />
	...
	<span class="txtContentTitle"><a href="javascript:openPopUp('/cart.php?act=printOrder&cart_order_id={ORDID}', 'contact', 750, 700, 0);" class="txtDefault">Printable Version</a></span>
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="7" cellspacing="0" style="padding: 7px;">
	 ...
	 <!-- BEGIN: repeat_products -->
	  ...
	  <!-- END: repeat_products -->
	  <tr>
	    <td rowspan="8" align="left" valign="bottom" class="btmSubNav" style="padding: 0px;"><table border="0" cellspacing="0" cellpadding="3">
          <tr>
	    ...
	    <td rowspan="8" class="btmSubNav">&nbsp;</td>
