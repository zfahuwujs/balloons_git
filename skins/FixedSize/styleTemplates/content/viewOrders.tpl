...
<div class="boxContent">
  ...
  <br />
	...
	<div>	
      ...
      <td class="tdcartTitle">Re-order</td>
		  </tr>
		  <!-- BEGIN: repeat_orders -->
		  <tr>
      ...
      <td align="center" class="{TD_CART_CLASS}"><a href="cart.php?act=viewOrder&amp;cart_order_id={DATA.cart_order_id}&amp;addToBasket=1" class="txtLink">Re-order</a></td>
		  </tr>
		  <!-- END: repeat_orders -->
		</table>
